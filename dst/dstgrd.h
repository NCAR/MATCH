...
!     Purpose: dstgrd.h contains grid sizes used to dimension variables in dust model
!     dstgrd.h is similar in function and usage to pmgrid.h 
!     dstgrd.h should be declared after dst.h but ahead of other dust headers
...
!     LSM grid size
!     NB: These numbers must agree with parameters in dstlsm.h
