...
c     Purpose: dstaer.h contains common blocks which store important 
c     microphysical properties of the mineral dust aerosol. 
c     Variables in dstaer are used each timestep by source and sink routines
...
c     dstaer.h MUST have access to dstgrd.h and to pmgrid.h to work
      
c     Usage:
c     #include <dstaer.h> /* Aerosol microphysical properties */
