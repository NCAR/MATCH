...
# Same as sarb4_hourly_202602_core but with soil moisture rescaled to match CDAS
...
export CASE=sarb4_hourly_202602_core_smrescale
vers='MATCH SARB4 C6 CORe SMrescale'
