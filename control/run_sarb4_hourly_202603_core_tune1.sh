#!/bin/bash
#
# MATCH run script for March 2026 — CORe meteorology, tuning trial 1
# 5-day Feb spin-up (Feb 24-28) + 5-day March sample (Mar 1-5) = 10 days
# Namelist overrides: vwc_scale=0.5, vwc_offset=0.15, sslt_scale=1.0
#
...
export CASE=sarb4_hourly_202603_core_tune1
vers='MATCH SARB4 C6 CORe tune1'
