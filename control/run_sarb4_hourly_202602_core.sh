#!/bin/bash
#
# MATCH run script for February 2026 — pure CORe-translated meteorology
# No spin-up: February 2026 only (28 days), cold start
#
...
export CASE=sarb4_hourly_202602_core
