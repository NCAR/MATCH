#!/bin/bash
#
# MATCH run script for March 2026 — CORe meteorology
# 10-day Feb spin-up (Feb 19-28) + March 2026 (31 days) = 41 days
# Default namelist tuning (no vwc_scale/sslt_scale overrides)
#
...
export CASE=sarb4_hourly_202603_core
vers='MATCH SARB4 C6 CORe'
