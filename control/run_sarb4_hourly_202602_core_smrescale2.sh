#!/bin/bash
#
# MATCH run script for February 2026 — CORe meteorology with SOILW floor at 0.1
# Same as sarb4_hourly_202602_core but with soil moisture floored to match CDAS
# encoding minimum, to test dust AOD continuity between CDAS and CORe inputs.
#
...
export CASE=sarb4_hourly_202602_core_smrescale2
vers='MATCH SARB4 C6 CORe SMrescale2'
